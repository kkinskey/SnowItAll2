...
public class MasteryTestController {

        @FXML
        private Label questionText;

        @FXML Label testresults;
        ...
        private MasteryTestModel model;
        ...
        public MasteryTestModel getModel() {
            return model;
        }
        ...
        public MasteryTestController() {
            this.model = new MasteryTestModel();
...
//    Handle Button Methods
        ...
        private void handleNextButtonToFIB(ActionEvent event) throws Exception{
            ...
            MasteryTestModel model = new MasteryTestModel();
    ...
    int count = 0;
        ...
        public void handleFIBsubmitButton() {
            count++;
            model.setQuestionNumber(count + 1);
            if (count == 10) {
                submitButtonFIB.setDisable(true);
                nextQuestionButton.setVisible(false);
                exitTest.setVisible(true);
                testresults.setVisible(true);
                testresults.setText("You got " + model.getCorrectAnswerCount() * 10 + "% of the questions correct");
